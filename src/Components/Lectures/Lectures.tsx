...
export class Lectures extends React.Component<LectureProps> {
	...
	myRows: RowOptions[] = [
        ...
        { cellNames: ["1/31", "A* Search", "R&N 3.5.2-3.7", "Notes", "Pathfinding Visualizations"], cellNametoLinks: new Map<string,string>([["Notes", "./lecture_notes/informed_search.pdf"],["Pathfinding Visualizations", "https://qiao.github.io/PathFinding.js/visual/"]]),autoReleaseDate: "Mar 16, 2025 04:00:00 EDT"  },
        { cellNames: ["2/3", "Adversarial Search", "R&N 5.0-5.3", "Notes", " "], cellNametoLinks: new Map<string,string>([["Notes", "./lecture_notes/adversarial_search.pdf"]]) ,autoReleaseDate: "Mar 16, 2025 04:00:00 EDT" },
        /**
