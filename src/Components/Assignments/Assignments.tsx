...
export class Assignments extends React.Component<AssignmentProps> {
    ...
    myRows: RowOptions[] = [
        {
            cellNames: ["Homework 0: Uninformed Search", "1/22", "1/30"], 
        ...
        /** 
        {
            cellNames: ["Homework 1: A*", "1/22", "1/30"], 
            cellNametoLinks: new Map<string, string>([
        ...
        {
            cellNames: ["Homework 2: Adversarial Search", "1/22", "1/30"], 
            cellNametoLinks: new Map<string, string>([
        ...
        {
            cellNames: ["Homework 3: SAT", "1/22", "1/30"], 
            cellNametoLinks: new Map<string, string>([
        ...
        {
            cellNames: ["Homework 4: Decision Trees", "1/22", "1/30"], 
            cellNametoLinks: new Map<string, string>([
        ...
        {
            cellNames: ["Homework 5: Numpy/Linear Algebra/Probability Review, LP", "1/22", "1/30"], 
            cellNametoLinks: new Map<string, string>([
        ...
        {
            cellNames: ["Homework 6: Linear Regression", "1/22", "1/30"], 
            cellNametoLinks: new Map<string, string>([
        ...
        {
            cellNames: ["Homework 7: Neural Networks", "1/22", "1/30"], 
            cellNametoLinks: new Map<string, string>([
        ...
        {
            cellNames: ["Homework 8: MDPs and Reinforcement Learning", "1/22", "1/30"], 
            cellNametoLinks: new Map<string, string>([
        ...
        {
            cellNames: ["Homework 9: Reinforcement Learning and Function Approximation", "1/22", "1/30"], 
            cellNametoLinks: new Map<string, string>([
        ...
        {
            cellNames: ["Final Project Part 1", "1/22", "1/30"], 
            cellNametoLinks: new Map<string, string>([
        ...
        {
            cellNames: ["Final Project Part 2", "1/22", "1/30"], 
            cellNametoLinks: new Map<string, string>([
        ...
        {
            cellNames: ["Final Project Part 3", "1/22", "1/30"], 
            cellNametoLinks: new Map<string, string>([
